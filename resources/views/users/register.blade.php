@php
    $property_types = ['Detached', 'Semi-detached', 'terraced', 'flat', 'cottage', 'bungalow', 'mansion'];
@endphp

<x-app pageTitle="Register ">
    <section class="bg-gray-50 dark:bg-gray-900 py-8">
        <div class="grid place-items-center my-8  px-6 py-8 lg:py-0">
            ...
            <div
                class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-5xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="property_type"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select property
                                    type</label>
                                <select id="property_type" name="property_type"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">Seelect an option</option>

                                    @foreach ($property_types as $item)
                                        @if (old('property_type') == $item)
                            ...
                            <div>
                                <label for="bedroom_count"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of
                                    bedrooms</label>
                                <input type="number" name="bedroom_count" id="bedroom_count" placeholder="3"
                            ...
                            <div>
                                <label for="evc_code"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">EVC
                                    code</label>
                                <input type="text" name="evc_code" id="evc_code" placeholder="xxxxxxxx"
                                    value="{{ old('evc_code') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                @error('evc_code')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
