        ...
        <div
                ...
                <div>
                    ...
                    <ul class="mt-1.5 ml-4 list-disc list-inside">
                        ...
                        <li>Valid evc codes are: <span class="text-red-500">
                            ...
                            unavailable</li>
                        <li>Validtion: The new meter reading is less than a previous reading</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                ...
                <div>
                    ...
                    <ul class="mt-1.5 ml-4 list-disc list-inside">
                        <li><span class="text-purple-500">{{ route('home') }}</span> <span class="text-green-500">anyone
                                can
                                access</span>
                        </li>
                        <li><span class="text-purple-500">{{ route('register') }}</span> <span class="text-green-500">
                                only non logged-in user can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('login') }}</span> <span class="text-green-500">
                                only non logged-in user can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('password.request') }}</span> <span
                                class="text-green-500">
                                only non logged-in user can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('user.logout') }}</span> <span
                                class="text-green-500">
                                any logged-in user can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('users.verification-emai') }}</span> <span
                                class="text-green-500">
                                any logged-in user can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('users.profile') }}</span> <span
                                class="text-green-500">
                                any logged-in user (Role: customer) can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('meaterReadings.add') }}</span> <span
                                class="text-green-500">
                                any logged-in user (Role: customer) can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('admin.dashboard') }}</span> <span
                                class="text-green-500">
                                any logged-in user (Role: admin) can access
                            </span>
                        </li>
                        <li><span class="text-purple-500">{{ route('admin.setprice') }}</span> <span
                                class="text-green-500">
                                any logged-in user (Role: admin) can access
                            </span>
                        </li>
